...
Update all Billing information
	...
	Add Country
	Add VAT number
	Click element				                xpath://*[@id="app"]/div[5]/div/div/div/button
...
Add Country
    Wait until page contains element    class:v-select__selections
	Click Element                       class:v-select__selections
	Scroll element into view            xpath://*[@id="app"]/div[1]/div/div/div[20]/a/div/div
	Scroll element into view            xpath://*[@id="app"]/div[1]/div/div/div[40]/a/div/div
	Scroll element into view            xpath://*[@id="app"]/div[1]/div/div/div[60]/a/div/div
	Scroll element into view            xpath://*[@id="app"]/div[1]/div/div/div[80]/a/div/div
	Scroll element into view            xpath://*[@id="app"]/div[1]/div/div/div[100]/a/div/div
	Scroll element into view            xpath://*[@id="app"]/div[1]/div/div/div[120]/a/div/div
	Scroll element into view            xpath://*[@id="app"]/div[1]/div/div/div[140]/a/div/div
	Scroll element into view            xpath://*[@id="app"]/div[1]/div/div/div[160]/a/div/div
	Scroll element into view            xpath://*[@id="app"]/div[1]/div/div/div[180]/a/div/div
	Scroll element into view            xpath://*[@id="app"]/div[1]/div/div/div[200]/a/div/div
	Scroll element into view            xpath://*[@id="app"]/div[1]/div/div/div[209]/a/div/div
    Click element                       xpath://*[@id="app"]/div[1]/div/div/div[209]/a/div/div
...
Verify Company Name
    wait until page contains element            xpath://*[@id="app"]/div[6]/div[1]/main/div/div/div[2]/div/div/div/div/div[2]/div[1]/div/div[2]/div[1]/div/div[2]
